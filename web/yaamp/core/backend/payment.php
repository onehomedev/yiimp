...
function BackendCoinPayments($coin)
{
    ...
    if($coin->symbol == 'BITC' || $coin->symbol == 'BNODE' || $coin->symbol == 'AVN' || $coin->symbol == 'RTM' || $coin->symbol == 'SPRX' || $coin->symbol == 'SWAMP' || $coin->symbol == 'ECC' || $coin->symbol == 'BCRS' || $coin->symbol == 'SAPP' || $coin->symbol == 'CURVE' || !empty($coin->payout_max))
    {
